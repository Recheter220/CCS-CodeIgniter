  ...
  <div class="row" id="pwd-container">
    ...
    <div class="col-md-4">
      <section class="login-form">
        <form method="post" action="<?= base_url('Login/auth') ?>" role="login">
          <!-- <img src="http://i.imgur.com/RcmcLv4.png" class="img-responsive" alt="" /> -->
          <h2> Faça seu login </h2>
          <input type="user" name="user" placeholder="Email" required class="form-control input-lg" value="" />
          ...
          <div>
            <a href="#">Crie sua conta</a> ou <a href="#">redefina sua senha</a>
          </div>
          
        </form>
        
        <div class="form-links">
          <a href="#">www.recheter220.com</a>
        </div>
      </section>  
      </div>
